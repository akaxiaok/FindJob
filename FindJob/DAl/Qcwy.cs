...
namespace FindJob.DAl
{
    public class Qcwy:IZhaoPin
    {
        ...
        public void GetJobListFromWeb()
        {
            ...
            HtmlDocument htmlDoc = htmlWeb.Load(string.Format("http://search.51job.com/jobsearch/search_result.php?jobarea={0}&keyword={1}&curr_page={2}", DataClass.GetDic_qiancheng(_pars.Addr), _pars.Key, _pars.Page));
